...
export default function HomeAbout() {
    return (
        ...
        <section className="component-content">
            ...
            <div className="row ">
                <div className="left-content col-md-6 col-lg-6 col-xl-6 ">
                    <div className="about-imgs">
                        <ul>
                            <li><img src={img1} alt="image-chiled-1" className=" about img1" /></li>
                            <li><img src={img2} alt="image-chiled-2" className=" about img2" /></li>
                            <li><img src={img3} alt="image-chiled-3" className=" about img3" /></li>
                            <li><div className="img-bx">
                                20
                    ...
                    {/* Right Section */}
                <div className="right-content col-md-6 col-lg-6 p-4 align-content-center align-content-center">
                    <div className="headig  align-content-center mb-2">
                        <h5>About Us</h5>
                        <h2>The Great Place Of Medical Hospital Center</h2>
                        <p>We provide the special tips and advice’s of heath care treatment and
                            high level of best technology involve in the our hospital.</p>
                    </div>
                    <div className="row">
                        <div className="col-md-6 col-lg-6 col-sm-12 ">
                            <div className="feature-box bx1">
                        ...
                        <div className="col-md-6 col-lg-6 col-sm-12 ">
                            <div className="feature-box bx2 d-flex ">
                                <div className="feature-icon">
