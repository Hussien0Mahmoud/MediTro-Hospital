...
<div className="services">
        <div className="container-fluid row">
            <div className="services_heading col-md-4 mb-5">
                <h6 className="d-inline-block">Services</h6>
                <h2 className="fs-1 fa-bold mb-3">We Cover A Big Variety Of Medical Services</h2>
                <p className="fs-6 mb-5">We provide the special tips and advice’s of heath care treatment and high level of
                    best.
                </p>
                <button className="btn btn-secondary btn-lg">All Services</button>
            </div>
            <div className="services_boxs col-md-8 mb-15 gap-4 d-flex">
                <div className="services_box bg-white d-flex flex-column justify-content-center">
